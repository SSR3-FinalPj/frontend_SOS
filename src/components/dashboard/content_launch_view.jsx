          ...
          <div className="flex items-start justify-between gap-4 mb-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                ...
                {/* 설명 텍스트 */}
                <p className={`text-xs mt-2 ${dark_mode ? 'text-gray-400' : 'text-gray-600'} max-w-xs`}>
                  AI로 새로운 영상을 생성합니다
                </p>
              </div>
              ...
              {pending_videos.filter(video => video.status === 'PROCESSING').length > 0 && (
                <div className="flex flex-col">
                  <Button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white shadow-lg font-semibold rounded-2xl animate-pulse"
                    size="lg"
                  >
